...
def serializedATN():
    return [
        ...
        19,1,0,0,0,5,22,1,0,0,0,7,26,1,0,0,0,9,28,1,0,0,0,11,30,1,0,0,0,
        13,32,1,0,0,0,15,35,1,0,0,0,17,18,5,40,0,0,18,2,1,0,0,0,19,20,5,
        41,0,0,20,4,1,0,0,0,21,23,7,0,0,0,22,21,1,0,0,0,23,24,1,0,0,0,24,
        22,1,0,0,0,24,25,1,0,0,0,25,6,1,0,0,0,26,27,5,43,0,0,27,8,1,0,0,
        0,28,29,5,45,0,0,29,10,1,0,0,0,30,31,5,42,0,0,31,12,1,0,0,0,32,33,
        5,47,0,0,33,14,1,0,0,0,34,36,7,1,0,0,35,34,1,0,0,0,36,37,1,0,0,0,
...
class ExpresionesSLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "NUM", "SUM", "RES", "MUL", "DIV", "WS" ]

    ruleNames = [ "T__0", "T__1", "NUM", "SUM", "RES", "MUL", "DIV", "WS" ]
